...
exports.startupHeaderMiddleware = exports.requestLoggingMiddleware = void 0;
...
// Middleware to add startup time header to all responses
const startupHeaderMiddleware = (req, res, next) => {
    const relativeStartupTime = (0, ecs_metadata_1.getRelativeStartupTime)();
